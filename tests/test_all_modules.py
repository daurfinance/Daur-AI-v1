...
def test_hardware_module():
    ...
    try:
        ...
        print(f"✓ Hardware status retrieved: {status}")
...
def test_security_module():
    ...
    try:
        ...
        token = security.create_token(user_id, UserRole.USER.value)
        ...
        valid, user_id_check = security.verify_api_key(api_key)
...
def test_integration():
    ...
    try:
        ...
        memory = hardware.get_memory_percent()
        disk = hardware.get_disk_percent()
        
        success = db.insert_hardware_metrics(cpu, memory, disk, 0.0, 0.0, 0.0, 0.0)
